...
class GUser(UserMixin, db.Model):
    ...
    avatarLarge = db.Column(db.String(255), nullable=True, index=True, unique=True, doc="头像大")
    avatarSmall = db.Column(db.String(255), nullable=True, index=True, unique=True, doc="头像小")
